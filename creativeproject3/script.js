    ...
    function dayOfWeekAsString(dayIndex) {
      return ["Monday", "Tuesday", "Wednesday", "Thursday",
                "Friday","Saturday","Sunday"][dayIndex];
    }
    ...
    $("#weatherSubmit").click(function(e) {
        ...
        var myurl= "http://api.openweathermap.org/data/2.5/weather?q=" + value + ",US&units=imperial" + "&APPID=9df3393e7778117f3ec4b435e405b4e1";
        //b38131d54ece97df704b9b020cf21f2c
